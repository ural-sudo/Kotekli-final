...
class GaleriFragment : Fragment() {
    ...
    private lateinit var galeriViewModel: GaleriViewModel
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_galeri, container, false)


        mWebView = root.findViewById<View>(R.id.webView11) as WebView
        mWebView!!.loadUrl("https://koteklirehber.com/galeri")
